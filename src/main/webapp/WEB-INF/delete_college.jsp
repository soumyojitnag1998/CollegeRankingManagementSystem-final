...
<body>
	...
	<center>
		<form action="deleteCollege" class="id">
			<br> <br>

			<p style="color: orange; font-size: 20px;">Enter College ID To
				Delete the College:</p>
			<input type="text" name="collegeId"
				placeholder="Enter the College ID" required>
