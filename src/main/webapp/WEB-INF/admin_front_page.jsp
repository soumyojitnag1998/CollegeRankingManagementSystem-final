	...
	firebase.auth().onAuthStateChanged(
			function(user) {
				if (!user) {
					...
					document.getElementById("email").innerHTML = firebase
...
<body>
		...
		<nav class="navbar navbar-expand-lg my-navbar">
			...
			<div class="menu">
				...
				<ul>
					...
					<li><i class="far fa-user"></i>
					<button onclick="logoutAdmin()">Logout</button></li>
	...
	<center>
		...
		<form class="content">
			<br>
			<h2 style="color: #ff952b; font-size: 30px;">Admin Actions</h2>
			<div class="vertical-menu">
				<a href="addCollege" name="addCollege" id="addCollege">Add
					College</a> <a href="collegeView" name="updateCollege"
					id="updateCollege">Update College</a> <a href="deleteCollegeView"
					name="deleteCollege" id="deleteCollege">Delete College</a>
			</div>
		</form>
	</center>
