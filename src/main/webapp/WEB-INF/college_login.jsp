...
<div class="container-fluid p-0">
    <nav class="navbar navbar-expand-lg my-navbar">
        ...
        <div class="menu">
          ...
          <li><i class="fas fa-school"></i><a href="login">Student Login</a></li>
...
<br>
	...
	<form onsubmit="loginCollege(event)"  class="content">
	<br>
