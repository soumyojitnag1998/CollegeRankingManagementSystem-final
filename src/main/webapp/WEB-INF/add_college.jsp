...
<link rel="stylesheet" href="add/NewFile.css">
...
<body>
	...
	<form:form onsubmit="/addCollege" method="post"
		modelAttribute="college" class="ad">
		<center>
			<br>
			<h2 style="color: #ff952b;">Enter Collge Details Here!</h2>
		</center>
