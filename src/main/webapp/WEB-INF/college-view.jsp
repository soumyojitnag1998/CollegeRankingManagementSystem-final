...
<html>
	...
	<link rel="stylesheet" href="css/Style.css">
	<link rel="stylesheet" href="college/view.css">
	<meta charset="ISO-8859-1">
	<meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
...
<script src="https://code.jquery.com/jquery-3.4.1.min.js"></script>
   ...
   <script>
	...
	<center>
	<form action="updateCollege" class="id">
	<br>
	<br>
	
		<p style="color:orange;font-size:20px;">Enter College ID To Update Details:</p>
		<input type="text" name="collegeId" placeholder="Enter your College ID" required>
		<br>
		<br>
